...
import { User, Mail, Lock, UserPlus, AlertCircle, CheckCircle, Sparkles } from "lucide-react";
    ...
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-950 via-cyan-950 to-slate-950">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <motion.div
          ...
          className="absolute bottom-1/3 left-1/4 w-96 h-96 bg-cyan-400/20 rounded-full blur-3xl"
        />
      </div>
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-white/60 text-sm">
              Start exploring hot topics today
            </p>
          </div>
